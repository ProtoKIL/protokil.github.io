...
- TODO — 대표 이미지: 전체 로봇 사진 또는 CAD 렌더
- TODO — 조립 구조: 프레임, 구동계와 센서 배치
- TODO — 시스템 구성: 센서 연결 또는 제어 구조
- TODO — 핵심 메커니즘: 비정형 지형 대응 구조
- TODO — 작동 영상: 산악 환경 주행, 맵핑 또는 탐지 결과
...
- TODO — 대표 이미지: PAS 센서와 전체 실험 장치
- TODO — 조립 구조: 센서 셀 및 측정 장비 구성
- TODO — 회로 구성: 증폭, 필터와 Lock-in Amplifier
- TODO — 핵심 결과: 필터 전후 파형 또는 위상 측정 결과
- TODO — 실험 영상: 측정 절차 또는 장비 작동
...
- TODO — 대표 이미지: 완성된 DIY Delta 3D Printer
- TODO — 조립 구조: 프레임, 델타 암과 베드
- TODO — 시스템 구성: 제어 보드, 전원과 배선
- TODO — 핵심 결과: 캘리브레이션 결과와 실제 출력물
- TODO — 작동 영상: 캘리브레이션 또는 출력 과정
